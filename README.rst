...
| OS                    |  Arch  | Compiler               |
+=======================+========+========================+
| Fedora Linux 21       | x86_64 | FSF GCC 4.9.2          |
+-----------------------+--------+------------------------+
...
* The API documentation (for Ahven 2.5, generated by Sphinx):
  http://www.ahven-framework.com/api-2.5/index.html
